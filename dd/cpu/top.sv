...
module top(
	...
	output	ROM_read,
	output	ROM_enable,
	output	[13:0]ROM_address, //12 in the hw4 explanation(+2 because word?)
	output	sensor_en,
	output	DRAM_CSn,
	output	[3:0]DRAM_WEn,
	output	DRAM_RASn,
	...
	assign ROM_address[13:12] = 2'b00;
	...
	DUALCORE_wrapper DUALCORE_wrapper1(
    	.CK(clk),
    	.RSTn(~rst),
		.ext_interrupt(sctrl_interrupt),
  		.AWID_M1(AWID_M1),
		.AWADDR_M1(AWADDR_M1),
		.AWLEN_M1(AWLEN_M1),
		.AWSIZE_M1(AWSIZE_M1),
